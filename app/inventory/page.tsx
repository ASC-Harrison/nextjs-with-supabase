                  ...
                  {item && (
                    <div className="found-panel">
                      ...
                      <div style={{background:"rgba(59,130,246,0.08)",border:"1px solid rgba(59,130,246,0.2)",borderRadius:"var(--r-lg)",padding:"14px",marginBottom:12}}>
                        ...
                        <button className="btn btn-submit btn-full btn-lg" style={{marginTop:12}} disabled={staffMissing} onClick={submit}>{mode==="USE"?`USE ${qty} — Submit`:`RESTOCK ${qty} — Submit`}</button>
