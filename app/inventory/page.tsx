                  ...
                  {item && (
                    <div className="found-panel">
                      ...
                      <div style={{background:"rgba(59,130,246,0.08)",border:"1px solid rgba(59,130,246,0.2)",borderRadius:"var(--r-lg)",padding:"14px",marginBottom:12}}>
                        ...
                        {(locked||staffMissing) && <div style={{fontSize:11,color:"var(--text4)",marginTop:6,textAlign:"center"}}>{staffMissing?"No staff detected — please log out and log back in.":"Unlock to submit."}</div>}
                      </div>
