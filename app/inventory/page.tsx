      ...
      {totalsEditOpen && totalsEditRow && (
        <AscModal title="Edit building totals" okText="Close" onCancel={()=>setTotalsEditOpen(false)} onOk={()=>setTotalsEditOpen(false)}>
          ...
          <div className="c-panel mb3">
            ...
            <div className="fx mt2">
              <input value={setOnHandInput} onChange={(e)=>setSetOnHandInput(e.target.value.replace(/[^\d]/g,""))} inputMode="numeric" className="inp" placeholder="e.g., 17" style={{flex:1,fontSize:18,fontWeight:800,textAlign:"center"}} />
