      ...
      <div style={{ width:"100%", maxWidth:400, background:"#162032", border:"1px solid #1e3a5f", borderRadius:20, padding:32, position:"relative", overflow:"hidden" }}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <input
            ...
            autoComplete="email"
            autoCapitalize="none"
            style={{ width:"100%", borderRadius:10, border:"1px solid #1e3a5f", background:"#111827", color:"#f0f6ff", padding:"13px 14px", fontSize:15, fontFamily:"inherit", outline:"none", marginBottom:14, boxSizing:"border-box" }}
          />
          ...
          <input
            ...
            style={{ width:"100%", borderRadius:10, border:"1px solid #1e3a5f", background:"#111827", color:"#f0f6ff", padding:"13px 14px", fontSize:15, fontFamily:"inherit", outline:"none", marginBottom:20, boxSizing:"border-box" }}
          />
          <button
            type="submit"
            disabled={loading}
            style={{ width:"100%", borderRadius:10, padding:14, fontSize:15, fontWeight:800, cursor:loading?"not-allowed":"pointer", border:"none", background:"linear-gradient(135deg,#3b82f6,#1d4ed8)", color:"#fff", fontFamily:"inherit", opacity:loading?0.6:1 }}
          >
        ...
        <div style={{ marginTop:20, fontSize:12, color:"#334155", textAlign:"center", lineHeight:1.6 }}>
          Contact your administrator if you need access.<br/>
