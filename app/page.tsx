      ...
      <div style={{ width:"100%", maxWidth:900 }}>
        ...
        {isAdmin && (
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(160px, 1fr))", gap:8, marginBottom:8 }}>
            ...
            <button onClick={() => router.push("/restock-requests")} style={{ ...btnBase, background:"rgba(168,85,247,0.15)", color:"#d8b4fe", border:"1px solid rgba(168,85,247,0.3)", marginBottom:0 }}>🔄 Restock Requests</button>
            <button onClick={() => router.push("/recount")} style={{ ...btnBase, background:"rgba(239,68,68,0.15)", color:"#fca5a5", border:"1px solid rgba(239,68,68,0.3)", marginBottom:0 }}>🔢 Recount Needed</button>
            <button onClick={() => router.push("/box-notes")} style={{ ...btnBase, background:"rgba(245,158,11,0.15)", color:"#fcd34d", border:"1px solid rgba(245,158,11,0.3)", marginBottom:0 }}>📦 Box Contents Notes</button>
            ...
            <button onClick={() => router.push("/pref-cards")} style={{ ...btnBase, background:"rgba(168,85,247,0.15)", color:"#d8b4fe", border:"1px solid rgba(168,85,247,0.3)", marginBottom:0 }}>🩺 Pref Cards</button>
          </div>
        )}
